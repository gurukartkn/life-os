  ...
  return (
    <div className="flex flex-col gap-3.5 rounded-2xl border border-border bg-surface-100 p-5">
      ...
      <form action={startWorkoutLog}>
        ...
        <button
          type="submit"
          className="text-button-text flex h-[38px] w-full items-center justify-center gap-1.5 rounded-md bg-teal-soft text-teal-ink transition-colors hover:bg-teal-soft/80"
        >
          Start workout
        </button>
      </form>
